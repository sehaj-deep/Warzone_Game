...
/**
 * The MapWriterAdapter class adapts a ConquestMapWriter to implement the
 * DominationWriter interface.
 */
public class MapWriterAdapter implements DominationWriter, Serializable {
