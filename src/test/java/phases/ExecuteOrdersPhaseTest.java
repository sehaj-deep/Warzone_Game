...
//					new HashSet<String>(Arrays.asList(Integer.toString(2 * i), Integer.toString(2 * i + 1))));
...
//				// FIXME: Commenting below line, please modify it accordingly.
...
//		// FIXME:Changed the above line as per my understanding
...
//		// FIXME: Changed above line as per my understanding
//
